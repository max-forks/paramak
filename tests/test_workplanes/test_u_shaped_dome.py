...
def test_construction():
    dome_section, cylinder_section = paramak.u_shaped_dome(
        upper_or_lower="lower", rotation_angle=360
    )
    ...
    domes = paramak.u_shaped_dome(
        upper_or_lower="upper", rotation_angle=360, reference_point=("lower", 10)
    )
    domes = paramak.u_shaped_dome(
        upper_or_lower="upper", rotation_angle=360, reference_point=("center", 20)
    )
