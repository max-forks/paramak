...
def test_creation_of_inner_leg():
    solid_without_inner_leg = paramak.toroidal_field_coil_princeton_d(
...
def test_rotation_angle():
    solid_360_uncut = paramak.toroidal_field_coil_princeton_d(
        azimuthal_placement_angles=[0, 180], rotation_angle=360
    )
    solid_180_uncut = paramak.toroidal_field_coil_princeton_d(
        azimuthal_placement_angles=[0, 180], rotation_angle=360
    )
    solid_180_cut = paramak.toroidal_field_coil_princeton_d(
