...
def create_reactor(
    ...
    reactor_height = elongation * radial_build[4][1] * 0.5 + sum(
        [layer[1] for layer in radial_build[5:]]
    )
...
os.system(
    "ffmpeg -r 10 -i spherical_tokamak_frame_%3d.png -c:v libx264 -r 30 -pix_fmt yuv420p spherical_tokamak_animation.mp4"
)
